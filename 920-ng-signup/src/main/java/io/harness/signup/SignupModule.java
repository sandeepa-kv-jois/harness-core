...
public class SignupModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    if (DeployMode.isOnPrem(deployMode)) {
      bind(SignupNotificationHelper.class).to(SaasSignupNotificationHelper.class).in(Singleton.class);
      bind(SignupNotificationTemplateLoader.class);
    } else {
      bind(SignupNotificationHelper.class).to(OnPremSignupNotificationHelper.class).in(Singleton.class);
    }
  }
